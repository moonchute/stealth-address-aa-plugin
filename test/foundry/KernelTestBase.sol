...
import {Compatibility} from "kernel/abstract/Compatibility.sol";
...
import {Call, ExecutionDetail} from "kernel/common/Structs.sol";
import {ValidationData, ValidUntil, ValidAfter} from "kernel/common/Types.sol";
import {KERNEL_VERSION, KERNEL_NAME} from "kernel/common/Constants.sol";
